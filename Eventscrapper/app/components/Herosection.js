...
import { CalendarSearch, Filter, Ticket, Sparkles } from "lucide-react";
...
export default function Page() {
  ...
  const features = [
    {
      icon: <CalendarSearch className="mb-4" />,
      title: "Real-Time Event Discovery",
      description:
        "Stay updated with the latest concerts, workshops, meetups, and festivals scraped directly from trusted sources.",
    },
    {
      icon: <Filter className="mb-4" />,
      title: "Smart Search & Filters",
      description:
        "Easily find events that match your interests using advanced search, categories, and location-based filtering.",
    },
    {
      icon: <Ticket className="mb-4" />,
      title: "Easy Event Booking",
      description:
        "Book tickets for your favorite events directly through the platform with a smooth and secure booking process.",
    },
    {
      icon: <Sparkles className="mb-4" />,
      title: " Personalized Recommendations",
      description:
        "Get tailored event suggestions based on your preferences and past activities, ensuring you never miss out on what you love.",
    },
  ];
      ...
      >
        ...
        <div className="z-10 text-center px-6 max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-emerald-400 to-purple-500">
            Welcome to Event Scrapper
          </h1>
          <p className="text-xl md:text-2xl mb-8 text-gray-300">
           Our platform scrapes and displays the latest events happening in your city, so you never miss out on the fun!
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="bg-gray-900 rounded-xl p-6 shadow-lg transition-all duration-300 hover:shadow-emerald-500/20 hover:shadow-xl border border-gray-800 hover:border-emerald-500/50 active:shadow-emerald-500/20 active:shadow-xl  active:border-emerald-500/50 flex flex-col items-center text-center"
              >
